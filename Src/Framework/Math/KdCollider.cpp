...
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
bool KdCollider::Intersects(std::weak_ptr<GameObject> GameObject , const SphereInfo& targetShape, const Math::Matrix& ownerMatrix, std::list<KdCollider::CollisionResult>* pResults) const
{
	// 当たり判定無効のタイプの場合は返る
	...
	for (auto& collisionShape : m_collisionShapes)
	{
		...
		if (collisionShape.second->Intersects(targetShape.m_sphere, ownerMatrix, pTmpRes))
		{
			...
			tmpRes.m_collisionType = targetShape.m_type;
			tmpRes.m_shapeType = KdCollider::ShapeType::Sphere;
			tmpRes.m_hitGameObject = GameObject;
...
// 第3引数に詳細結果の受け取る機能が付いている
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
bool KdCollider::Intersects(std::weak_ptr<GameObject> GameObject , const BoxInfo& targetBox, const Math::Matrix& ownerMatrix, std::list<KdCollider::CollisionResult>* pResults) const
{
	// 当たり判定無効のタイプの場合は返る
	if (targetBox.m_type & m_disableType) { return false; }
	...
	for (auto& collisionShape : m_collisionShapes)
	{
		...
		if (isIntersects)
		{
			...
			tmpRes.m_collisionType = targetBox.m_type;
			tmpRes.m_shapeType = KdCollider::ShapeType::Box;
			tmpRes.m_hitGameObject = GameObject;
			pResults->push_back(tmpRes);
		}
	}
...
// 第3引数に詳細結果の受け取る機能が付いている
// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// ///// /////
bool KdCollider::Intersects(std::weak_ptr<GameObject> GameObject , const RayInfo& targetShape, const Math::Matrix& ownerMatrix, std::list<KdCollider::CollisionResult>* pResults) const
{
	// 当たり判定無効のタイプの場合は返る
	if (targetShape.m_type & m_disableType) { return false; }
	...
	for (auto& collisionShape : m_collisionShapes)
	{
		...
		if (collisionShape.second->Intersects(targetShape, ownerMatrix, pTmpRes))
		{
			...
			tmpRes.m_collisionType = targetShape.m_type;
			tmpRes.m_shapeType = KdCollider::ShapeType::Ray;
			tmpRes.m_hitGameObject = GameObject;
			pResults->push_back(tmpRes);
		}
	}
